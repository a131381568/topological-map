<template>
  <header class="px-4 pt-6 navbar navbar-expand flex-wrap">
    <div class="logo-container navbar-collapse w-100 justify-content-center">
      <router-link class="navbar-brand" to="/">
        <svg
          ...
          width="176px"
          height="152px"
          viewBox="-0.8 -0.3 176 152"
          enable-background="new -0.8 -0.3 176 152"
          xml:space="preserve"
        >
          <defs>
            <pattern
          ...
          <polygon
            fill="#403449"
            points="82.7,75.4 83.8,73.5 106.7,33.9 87.1,0 43.6,75.4 87.1,150.9 106.7,117 83.8,77.4"
          />
          <polygon
            fill="#403449"
            points="59.8,111.3 43.6,139.4 6.6,75.4 43.6,11.5 59.8,39.6 63.1,33.9 43.6,0 0,75.4 43.6,150.9 63.1,117"
          />
          <polygon
            fill="#403449"
            points="129.7,66.2 129.7,66.2 129.7,54.1 102.3,101.7 105.7,107.7"
          />
          <polygon
            fill="#403449"
            points="129.7,49.6 129.7,49.6 129.7,37.4 97.5,93.3 100.9,99.4"
          />
          <polygon
            fill="#403449"
            points="91.3,82.7 129.7,16.3 129.7,16.3 129.7,1.7 87.1,75.4"
          />
          <polygon
            fill="#403449"
            points="129.7,33 129.7,33 129.7,20.8 92.7,85 96.1,91.1"
          />
          <polygon fill="#403449" points="131.6,1.7 131.6,149.2 174.3,75.4" />
          <polygon
            fill="#403449"
            points="129.7,82.9 129.7,82.9 129.7,70.7 107.1,110 110.6,116"
          />
          <polygon
            fill="#403449"
            points="129.7,99.5 129.7,99.5 129.7,87.4 111.9,118.3 115.4,124.3"
          />
          <polygon
            fill="#403449"
            points="129.7,133.4 125.2,141.3 129.7,149.2"
          />
          <polygon
            fill="#403449"
            points="123.8,139 129.7,128.9 129.7,128.9 129.7,120.6 121.5,134.9 123.8,139"
          />
          <polygon
            fill="#403449"
            points="129.7,116.1 129.7,116.2 129.7,104 116.7,126.6 120.2,132.7"
          />
        </svg>
      </router-link>
    </div>
